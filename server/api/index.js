...
module.exports = {
    ...
    userPeopleList: { path: '/personnel/peopleList', component: userPeopleList },
    userAddOrModifyPeople: { path: '/personnel/addOrModifyPeople', component: userAddOrModifyPeople },
    userDeletePeople: { path: '/personnel/deletePeople', component: userDeletePeople },
    userGetPeople: { path: '/personnel/getPeople', component: userGetPeople },
